...
if __name__ == '__main__':
    ...
    for i in range(0, epochs):
        ...
        if (i + 1) >= 1000:
            ...
            torch.save(checkpoint, './train_log_v7_visual_quant_333/CS_Omni_P2P_x4/CS_Omni_P2P_x4_{0}.pt'.format(i + 1))
            del net_list
        ...
        fp = open('train_log_v7_visual_quant_222/CS_Omni_P2P_x4/CS_Omni_P2P_x4.txt', 'a+')
        fp.write(str_write)
        fp.close()
