from ops.OmniSR_visual_quant import LR_SR_x4_v4_quant, LR_SR_x4_v2_quant
import torch
import numpy as np
import math
import copy
from torch.utils.checkpoint import checkpoint
from data_v3v4 import MyDataset, Test
import time
...
if __name__ == '__main__':
    ...
    net_v2.load_state_dict(chpoint['model_state_dict'])
    net_v2.eval()
    for param in net_v2.parameters():
        param.requires_grad = False

    net_G = LR_SR_x4_v4_quant(kwards=kwards, net_v2_pretrained=net_v2).cuda()
    ...
    for i in range(0, epochs):
        ...
        if (i + 1) % 1 == 0:
            ...
            torch.save(checkpoint, './train_log_v4_visual_quant/CS_Omni_P2P_x4/CS_Omni_P2P_x4_{0}.pt'.format(i + 1))
            del net_list
        ...
        fp = open('./train_log_v4_visual_quant/CS_Omni_P2P_x4/CS_Omni_P2P_x4.txt', 'a+')
        fp.write(str_write)
        fp.close()
