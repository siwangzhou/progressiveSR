...
for test_batch, (_, hrimg) in enumerate(test_data, start=0):
    ...
    if flag_visual:
        save_image(i1, './out_v2/' + str(index) + 'hr.png')
        save_image(i2, './out_v2/' + str(index) + 'sr.png')
        save_image(i3, './out_v2/' + str(index) + 'lr.png')
