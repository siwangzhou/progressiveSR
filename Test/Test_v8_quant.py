...
import torch
from ops.OmniSR import LR_SR_x4_v8_quant
...
chpoint= torch.load("./train_log_v8_quant/CS_Omni_P2P_x4/CS_Omni_P2P_x4_1260.pt")
...
for test_batch, (_, hrimg) in enumerate(test_data, start=0):
    ...
    if flag_visual:
        save_image(i1, './out_v8/' + str(index) + 'hr.png')
        save_image(i2, './out_v8/' + str(index) + 'sr.png')
        save_image(i3, './out_v8/' + str(index) + 'lr.png')
