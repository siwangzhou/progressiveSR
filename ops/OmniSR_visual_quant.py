...
class CS_DownSample_xDiff_v13(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=(13*13-8*8)*3, kernel_size=32, stride=32, padding=0)
...
class CS_DownSample_xDiff_v15(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=(14*14-8*8)*3, kernel_size=32, stride=32, padding=0)
...
class CS_DownSample_xDiff_v17(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=(15*15-8*8)*3, kernel_size=32, stride=32, padding=0)
...
class CS_DownSample_xDiff_v19(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(in_channels=3, out_channels=(16*16-8*8)*3, kernel_size=32, stride=32, padding=0)
